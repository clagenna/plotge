Under the pretext of studying the algorithm of Dijkstra "shortest path" I created a project that can be usefull for studies in java programming and contains different techniques.
